...
export RT-AX88U += BUILD_NAME="RT-AX88U" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
		...
		MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="network" \
...
export GT-AX11000 += BUILD_NAME="GT-AX11000" EXT_PHY="BCM84880" SWITCH2="" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
		...
		PRINTER=y WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y \
		...
		NTFS="tuxera" HFS="tuxera" NEWSSID_REV2=y NEW_APP_ARM=y BONDING=y BONDING_WAN=y NETOOL=y AURALED=y \
...
export RT-AX58U += BUILD_NAME="RT-AX58U" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y SW_CTRL_ALLLED=y \
		IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y \
		PRINTER=y WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y GAME_MODE=n \
...
export RT-AX56U += BUILD_NAME="RT-AX56U" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y SW_CTRL_ALLLED=y \
		...
		PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y \
...
export RT-AX86U += BUILD_NAME="RT-AX86U" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y HND_WL=y \
		...
		ACCEL_PPTPD=y PRINTER=y WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="network" \
...
export RT-AX68U += BUILD_NAME="RT-AX68U" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
		...
		WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="network" PROXYSTA=y DNSMQ=y BCMWL6=y BCMWL6A=y DISK_MONITOR=y \
...
export RT-AC68U_V4 += BUILD_NAME="RT-AC68U_V4" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
                      AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y \
                      WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="network" PROXYSTA=y DNSMQ=y BCMWL6=y BCMWL6A=y \
...
export GT-AXE11000 += BUILD_NAME="GT-AXE11000" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=y REPEATER=y IPV6SUPP=y \
                      ...
                      PRINTER=y WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y \
                      ...
                      NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=n ALEXA=y IFTTT=y SW_HW_AUTH=y HD_SPINDOWN=y AURALED=y \
...
export RT-AC88U_BASE := IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=3.6.x \
		MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=n FRS_FEEDBACK=n \
		...
		NOTIFICATION_CENTER=y NATNL_AICLOUD=y SYSSTATE=y SMARTSYNCBASE=n NATNL_AIHOME=y \
...
export GT-AX6000 += BUILD_NAME="GT-AX6000" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y \
		...
		ACCEL_PPTPD=y PRINTER=y WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="network" PROXYSTA=y \
		...
		RGBLED=n I2CTOOLS=n AMAS=y DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y CONNDIAG=y AURALED=y \
...
export GT-AXE16000 += BUILD_NAME="GT-AXE16000" EXT_PHY="BCM84880" NVSIZE="192" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y HTTPS=y \
		...
		WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y \
		...
		BCMBSD_V2=y SW_CTRL_ALLLED=y COMFW=y CABLEDIAG=y MAX_VPNF=4 WTFAST_V2=y AURALED=y \
...
export GT-AX11000_PRO += BUILD_NAME="GT-AX11000_PRO" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y \
		...
		WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y DISK_MONITOR=y \
		...
		ADGUARDDNS=y CAPTIVE_PORTAL=y CP_FREEWIFI=y MTLANCFG=y MTPPP=y MULTISERVICE_WAN=y WPA3_ENTERPRISE=y AURALED=y \
		NFS=y SNMPD=y TOR=y UPNPIGD2=y NANO=y NTPD=y IPSET=y VPN_FUSION_MERLIN=y
...
export RT-AX86U_PRO += BUILD_NAME="RT-AX86U_PRO" NVSIZE="128" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y \
		BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=n SMARTSYNCBASE=n \
...
export RT-AX88U_PRO += BUILD_NAME="RT-AX88U_PRO" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
		...
		WEBDAV=n SMARTSYNCBASE=n USB="USB" APP="installed" PROXYSTA=y DNSMQ=y BCMWL6=y BCMWL6A=y DISK_MONITOR=y OPTIMIZE_XBOX=y \
		ODMPID=y BCMSMP=y XHCI=y DUALWAN=y NEW_USER_LOW_RSSI=y OPENVPN=y TIMEMACHINE=y MDNS=y VPNC=y JFFS2LOG=y BWDPI=y \
...
export RT-BE96U += BUILD_NAME="RT-BE96U" EXT_PHY="BCM84880" NVSIZE="192" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
		...
		OWE_TRANS=y EXTEND_LIMIT=y GOOGLE_ASST=y LED_BTN=y WIREGUARD=y BCMBSD_V2=y AURALED_NIGHT=y AURALED=y \
...
export GT-BE98_PRO += BUILD_NAME="GT-BE98_PRO" EXT_PHY="BCM84880" NVSIZE="192" DHDAP=y DPSTA=n REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
		AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=n \
		SMARTSYNCBASE=n USB="USB" APP="network" PROXYSTA=y DNSMQ=y SHP=n BCMWL6=y BCMWL6A=y DISK_MONITOR=y BTN_WIFITOG=y \
		OPTIMIZE_XBOX=y ODMPID=y BCMSMP=y XHCI=y DUALWAN=y NEW_USER_LOW_RSSI=y OPENVPN=y TIMEMACHINE=y MDNS=y VPNC=y \
		JFFS2LOG=y BWDPI=y DUMP_OOPS_MSG=n LINUX_MTD="64" DEBUGFS=y TEMPROOTFS=n SSH=y EMAIL=y FRS_FEEDBACK=n SYSSTATE=y \
		...
		MTLANCFG=y CAPTIVE_PORTAL=y CP_FREEWIFI=y WPA3_ENTERPRISE=y DOWNGRADE_CHECK=y AURALED_NIGHT=y AURALED=y \
		EXTRA_KERNEL_CONFIGS="BCM_JUMBO_FRAME=y BCM_MAX_MTU_SIZE=10240 CONFIG_BCM_IGNORE_BRIDGE_MTU=y" MAX_VPNF=4 \
		WTFAST_V2=y AMAS_OB_DISABLE_DSAP=y USB_WAN_BACKUP=y AUTO_WANPORT=y MULTISERVICE_WAN=y \
		NFS=n SNMPD=y TOR=y UPNPIGD2=y NANO=y NTPD=y IPSET=y VPN_FUSION_MERLIN=y
...
export RT-BE88U += BUILD_NAME="RT-BE88U" EXT_PHY="BCM84880" NVSIZE="192" DHDAP=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y \
		...
		DOWNGRADE_CHECK=y AUTO_WANPORT=y GEARUPPLUGIN=y SECURE_BY_DEFAULT=y \
		EXTRA_KERNEL_CONFIGS="BCM_JUMBO_FRAME=y BCM_MAX_MTU_SIZE=10240 CONFIG_BCM_IGNORE_BRIDGE_MTU=y" \
		NFS=n SNMPD=y TOR=y UPNPIGD2=y NANO=y NTPD=y IPSET=y VPN_FUSION_MERLIN=y
...
export RT-BE86U += BUILD_NAME="RT-BE86U" EXT_PHY="BCM84880" NVSIZE="192" DHDAP=y HND_WL=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y \
		AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=n \
		SMARTSYNCBASE=n USB="USB" APP="network" PROXYSTA=y DNSMQ=y BCMWL6=y BCMWL6A=y DISK_MONITOR=y OPTIMIZE_XBOX=y ODMPID=y \
...
export HND-96764_BASE := HND_ROUTER=y HND_ROUTER_BE_4916=y PROFILE="96764GW_WL23D2D1GA_WLMLO" SW_HW_AUTH=y AMAS=y UTF8_SSID=y ETHOBD=y DWB=y CONNDIAG=y SAMBA3="3.6.x" WL_SCHED_V3=y UBI=y UBIFS=y PSISTLOG=y CABLEDIAG=y

export RT-BE58_GO := $(HND-96764_BASE)
export RT-BE58_GO += BUILD_NAME="RT-BE58_GO" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=n HND_WL=y REPEATER=y IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y \
		BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y USB_WAN_BACKUP=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y USB="USB" APP="network" \
		PROXYSTA=y DNSMQ=y BCMWL6=y BCMWL6A=y DISK_MONITOR=y OPTIMIZE_XBOX=y ODMPID=y BCMSMP=y XHCI=y DUALWAN=y NEW_USER_LOW_RSSI=y OPENVPN=y \
		TIMEMACHINE=y MDNS=y VPNC=y JFFS2LOG=y LINUX_MTD="64" DEBUGFS=y SSH=y EMAIL=y FRS_FEEDBACK=n SYSSTATE=y STAINFO=y CLOUDCHECK=n \
		NATNL_AICLOUD=y REBOOT_SCHEDULE=y MULTICASTIPTV=y QUAGGA=y BCM_MUMIMO=y LAN50="all" ATCOVER=y GETREALIP=y CFEZ=y ETLAN_LED=y \
		TFAT=y NTFS="tuxera" HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y NEW_APP_ARM=y NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=n ALEXA=n \
		IFTTT=n HD_SPINDOWN=y BCMEVENTD=y LETSENCRYPT=y VPN_FUSION=y JFFS_NVRAM=y NVRAM_ENCRYPT=y IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV \
		NATNL_AIHOME=y BCM_CEVENTD=y DBLOG=y CFGSYNC_LOCSYNC=y CRASHLOG=y WATCH_REINIT=n BW160M=y BRCM_HOSTAPD=y IPERF3=y FRS_LIVE_UPDATE=n \
		ASUSCTRL=y BCN_RPT=y BTM_11V=y INFO_EXAP=y AVBLCHAN=y SW_CTRL_ALLLED=y ASD=y AHS=n INTERNETCTRL=y INSTANT_GUARD=y ACL96=y \
		GOOGLE_ASST=y COMFW=y WIREGUARD=y AMAS_ETHDETECT=y NFCM=n DNSQUERY_INTERCEPT=y UUPLUGIN=y CAPTCHA=y GAME_MODE=n FRONTHAUL_DWB=y \
		OWE_TRANS=y EXTEND_LIMIT=y BCMBSD_V2=y WIFI7=y PC_SCHED_V3=y MULTISERVICE_WAN=n MTLANCFG=y CAPTIVE_PORTAL=y CP_FREEWIFI=y \
		WPA3_ENTERPRISE=y AMAS_OB_DISABLE_DSAP=y AUTO_WANPORT=n HND_GPIO=y BCM_CLED=y I2CTOOLS=y LED_BTN=y SINGLE_LED=y SW_BTN=y HNS=y \
		WISP=y NVSWJFFS=y NO_AIDISK=y OOKLA=y PORT2_DEVICE=y \
		NFS=n SNMPD=y TOR=y UPNPIGD2=y NANO=y NTPD=y IPSET=y VPN_FUSION_MERLIN=y
